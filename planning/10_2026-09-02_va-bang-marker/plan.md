...
- [ ] **P01 🔴 [WP1]** — theo SPEC-P01/P02. Gate: `tests/unit/marker.test.js` xanh với **input viết tay** (không fixture, không golden); 5/5 dạng hỏng có test; `patch-agents.test.js` cũ **đã bị xoá và đã ghi nhận lượt chạy đỏ** trước khi viết bản mới (Đ8.3).

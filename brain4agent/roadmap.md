...
- [ ] **[#11 — ưu tiên cao] Engine TỪ CHỐI hạ `brain_template_version`.** Bài học gotcha #12 chưa bao giờ được cài thành luật máy, và trong đợt #10 nó gây **2 sự cố thật**: bản global cũ chạy ở chế độ ghi đã kéo ngược hub từ `1.4.0` về `1.3.0`. Engine phải thoát ≠ 0 khi phiên bản đích **thấp hơn** phiên bản đang có, thay vì âm thầm ghi đè.

...
- [ ] **[#10 — ưu tiên cao] Chuyển cơ chế vá sang khối đánh dấu ẩn** (`<!-- brain:rule ... -->`): vá = thay nội dung giữa hai mốc, thay cho dò tiêu đề bằng regex trên văn xuôi tiếng Việt. Diệt tận gốc họ lỗi "regex trượt". **Điều kiện cần:** đã có lưới test (xong ở #09). **Chi phí:** kéo theo một đợt ghi vào ~66 repo ⇒ phải có người bấm nút.
